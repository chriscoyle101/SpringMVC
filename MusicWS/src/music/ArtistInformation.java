        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected music.ArtistInfo[] localArtistInformation ;
                           ...
                           */
                           public  music.ArtistInfo[] getArtistInformation(){
                               ...
                               */
                              protected void validateArtistInformation(music.ArtistInfo[] param){
                              ...
                              */
                              public void setArtistInformation(music.ArtistInfo[] param){
                             ...
                             * @param param music.ArtistInfo
                             */
                             public void addArtistInformation(music.ArtistInfo param){
                                   if (localArtistInformation == null){
                                   localArtistInformation = new music.ArtistInfo[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localArtistInformation);
                             ...
                             (music.ArtistInfo[])list.toArray(
                            new music.ArtistInfo[list.size()]);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArtistInformation".equals(type)){
                                ...
                                return (ArtistInformation)music.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(music.ArtistInfo.Factory.parse(reader));
                                                        ...
                                                        object.setArtistInformation((music.ArtistInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                music.ArtistInfo.class,
                                                                list1));
