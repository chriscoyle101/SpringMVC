...
public class MusicService extends MusicServiceSkeleton {
	...
	private ArtistInfo[] getByField(String field, String value) throws ErrorFaultException {
		try {
			...
			Connection connection = DriverManager.getConnection(databaseHost, databaseUser, databasePassword );
			Statement statement = connection.createStatement();
			
			String query = "SELECT" + " ng_singers.name," + " ng_singers.dob," + " ng_singers.sex," + " ng_albums.album_name," + " ng_albums.release_year," +" ng_albums.record_company" +
					   		" FROM"  +	" ng_singers" +
					   		" INNER JOIN" + " ng_albums" + 
